...
Dtabase.then(async (db) => {
    ...
    /* O horário que a pessoa trabalha, por exemplo, é das
    8h - 18h. O horário do time_from (8h) precisa ser menor
    ou igual ao horário solicitado. O time_to precisa ser 
    acima */
